...
if (!empty($errors)) {
    ...
    if (isset($_POST['tipe'])) {
        ...
        if (strtolower(trim($_POST['tipe'])) == 'daripromo') {
            ...
            echo json_encode(['success' => true, 'redirect_uri' => 'index.php?page=thankyouPagePromo&idpr='.$ambilpromo_en]);
        } else if (strtolower(trim($_POST['tipe'])) == 'dariproduk') {
            ...
            http_response_code(200);
            echo json_encode(['success' => true, 'redirect_uri' => 'index.php?page=thankyouPage&idpr='.$ambilproduct_en]);
            // echo ("<script LANGUAGE='JavaScript'>
