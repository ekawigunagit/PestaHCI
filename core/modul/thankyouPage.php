...
$data_product = "SELECT * FROM products LEFT JOIN category_products ON products.category_product_id = category_products.id WHERE products.status=1 AND products.id='$idpr'";
$query_data_product = mysqli_query($koneksi, $data_product);
$show_data_product = $query_data_product->fetch_assoc();
?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 QR_Scan">
                        <!-- Coloum 1 -->
                             <img src="images/qrcategory/<?php echo $show_data_product['image_qr']; ?>" >
                    </div> <!-- End of Coloum 1 -->
                        ...
                        <div class="order checkout_section" style="height: 100%;">
                            ...
                            <div class="order_list_container">
                                <div class="order_list_bar d-flex flex-row align-items-center justify-content-start">
                                    ...
                                    <div class="order_list_value ml-auto"><?php echo $show_data_product['category_product_id']; ?></div>
                                </div>
                                <ul class="order_list">
                                    <li class="d-flex flex-row align-items-center justify-content-start">
                                        <div class="order_list_title">Product Type :</div>
                                        <div class="order_list_value ml-auto"><?php echo $show_data_product['product_name']; ?></div>
                                    </li>
                                </ul>
                            </div>
